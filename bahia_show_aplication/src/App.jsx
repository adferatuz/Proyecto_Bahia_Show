...
import Eventos from './components/aplicacion/servicios/eventos'
              ...
              <Routes>
                ...
                <footer>
                  <div className='contenedor-icons '>
                      <div className='icons'><a href=""><i className='bi bi-tiktok' id='tiktok'></i></a></div>
                      <div className='icons'><a href=""><i className='bi bi-whatsapp' id='whatsapp'></i></a></div>
                      <div className='icons'><a href=""><i className='bi bi-instagram' id='instagram'></i></a></div>
                      <div className='icons'><a href="https://www.youtube.com/@BAHIASHOWORQUESTA/videos"><i className='bi bi-youtube' id='youtube'></i></a></div>
                      <div className='icons'><a href=""><i className='bi bi-telegram' id='telegram'></i></a></div>
                      <div className='icons'><a href=""><i className='bi bi-facebook' id='facebook'></i></a></div>  
                  </div>
                  <div>  
